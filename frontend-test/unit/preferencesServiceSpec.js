  ...
  describe('Preferences service', function () {
    ...
    describe('buildImportance', function () {
      ...
      it('should work for missing preferences', function () {
        var result = preferencesService.buildImportances(criteria, {});
        var expectedResult = {
          crit1: '?',
          crit2: '?',
          crit3: '?'
        ...
        result = preferencesService.buildImportances(criteria, undefined);
        expect(result).toEqual(expectedResult);
      });
      it('should work for ordinal preferences', function () {
        ...
        var result = preferencesService.buildImportances(criteria, prefs);
        var expectedResult = {
          crit1: 2,
          crit2: 1,
          crit3: 3
