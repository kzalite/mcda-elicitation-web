...
define(function () {
  var tasks = {
    available: [
      ...
      {
        id: 'choice-based-matching',
        title: 'Choice Based Matching Elicitation',
        controller: 'ChoiceBasedMatchingController',
        templateUrl: './preferences/choiceBasedMatching.html',
        requires: ['partial-value-function'],
        resets: ['criteria-trade-offs']
      },
      {
